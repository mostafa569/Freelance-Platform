...
const fetchEmployers = async (page = 1) => {
  ...
  try {
    ...
    isFailed.value = true;
    errorMessage.value = error.response?.data?.message || 'Failed to fetch employers';
  } finally {
...
const deleteEmployer = async (id, page, event) => {
  event.preventDefault();
  try {
    const response = await api.deleteEmployer(id);
  ...
  <div class="">
    ...
    <div v-else class="content-container">
      ...
      <div class="d-flex align-items-center mb-1">
        ...
        <a href="mailto:{{ employer.email }}" class="text-primary text-truncate">
          {{ employer.email }}
        </a>
      </div>
    </td>
    <td>
      <div class="d-flex align-items-center">
        ...
        <a href="tel:{{ employer.phone }}" class="text-primary">
          {{ employer.phone }}
        </a>
      </div>
    </td>
      ...
      <div class="pagination-container">
        <div class="records-info">
          Showing {{ employers.meta?.from }} to {{ employers.meta?.to }} of
          {{ employers.meta?.total }} records
        </div>
        <nav aria-label="Page navigation">
          <ul class="pagination justify-content-center">
            <li
              v-for="link in employers.meta?.links"
              :key="link.label"
              class="page-item"
