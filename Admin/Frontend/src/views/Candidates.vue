...
const fetchCandidates = async (page = 1) => {
  ...
  try {
    ...
    isFailed.value = true;
    errorMessage.value = error.response?.data?.message || 'Failed to fetch candidates';
  } finally {
  ...
  <div class="">
    ...
    <div v-else class="content-container">
      ...
      <div class="d-flex align-items-center mb-1">
        ...
        <a href="mailto:{{ candidate.email }}" class="text-primary text-truncate">
          {{ candidate.email }}
        </a>
      </div>
    </td>
    <td>
      <div class="d-flex align-items-center">
        ...
        <a href="tel:{{ candidate.phone }}" class="text-primary">
          {{ candidate.phone }}
        </a>
      </div>
    </td>
